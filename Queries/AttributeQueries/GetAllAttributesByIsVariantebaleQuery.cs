...
{
    public class GetAllAttributesByIsVariantebaleQuery : QueryBase<ServiceResult<List<GetAllAttributesDto>>>
    {
        public GetAllAttributesByIsVariantebaleQuery(bool isVariantabale, string categoryId)
        {
        ...
        public class GetAllAttributesByIsVariantebaleQueryHandler : BaseRequestQueryHandler<GetAllAttributesByIsVariantebaleQuery, ServiceResult<List<GetAllAttributesDto>>>
        {

            private readonly IUnitOfWork<CategoryDbContext> unitOfWork;

            public GetAllAttributesByIsVariantebaleQueryHandler(ILogger<GetAllAttributesByIsVariantebaleQueryHandler> logger, IUnitOfWork<CategoryDbContext> _unitOfWork) : base(logger)
            {
            ...
            protected override async Task<ServiceResult<List<GetAllAttributesDto>>> HandleAsync(GetAllAttributesByIsVariantebaleQuery query, CancellationToken cancellationToken)
            {
